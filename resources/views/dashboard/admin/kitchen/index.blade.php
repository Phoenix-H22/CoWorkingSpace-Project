                    ...
                    <div class="col-12">
                        ...
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <div class="col-6 position-relative mb-2">
                                <a href="{{route('admin.kitchen.create')}}" class="btn btn-primary" style="position: absolute;right: 0;">Add Product</a>
                                <br>
                            </div>
                                    ...
                                    <tbody>
                                       @foreach ($products as $product)
                                        <tr>
                                            ...
                                            <td>{{$product->name}}</td>
                                            @if($product->category == 'cold_drinks')
                                            <td>Cold Drinks</td>
                                            @elseif($product->category == 'hot_drinks')
                                            <td>Hot Drinks</td>
                                            ...
                                            <td>
                                                <a href="{{route('admin.kitchen.edit',$product->id)}}" class="btn btn-primary">Edit</a>
                                                <a href="{{route('admin.kitchen.delete',$product->id)}}" class="btn btn-danger">Delete</a>
                                            </td>
                                        </tr>
                                        @endforeach
