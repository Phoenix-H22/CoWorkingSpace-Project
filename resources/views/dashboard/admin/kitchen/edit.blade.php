                ...
                <div class="row">
                    <div class="col-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            ...
                            <form action="{{route("admin.kitchen.update",$product->id)}}" method="post">
                                ...
                                <div class="form-floating mb-3">
                                    ...
                                    <select class="form-select" id="floatingSelect" aria-label="Category" name="category">
                                        <option value="cold_drinks" @if($product->category == 'cold_drinks') selected @else  @endif >Cold Drinks</option>
                                        <option value="hot_drinks" @if($product->category == 'hot_drinks') selected @else  @endif >Hot Drinks</option>
                                        <option value="food" @if($product->category == 'food') selected @else  @endif >Food</option>
                                    </select>
                                    @error('category')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                    @enderror
