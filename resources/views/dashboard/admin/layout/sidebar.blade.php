 ...
 <div class="sidebar pe-4 pb-3">
    <nav class="navbar bg-secondary navbar-dark">
        <a href="index.html" class="navbar-brand mx-4 mb-3">
            <h3 class="text-primary"><i class="fa fa-user-edit me-2"></i>Alien</h3>
        </a>
        ...
        <div class="navbar-nav w-100">
            ...
            <div class="nav-item dropdown">
                ...
                <div class="dropdown-menu bg-transparent border-0">
                    ...
                    <a href="typography.html" class="dropdown-item">Create User</a>
                </div>
            </div>
            ...
            <div class="nav-item dropdown">
                ...
                <div class="dropdown-menu bg-transparent border-0">
                    <a href="signin.html" class="dropdown-item">All Sessions</a>
                    <a href="signup.html" class="dropdown-item">Create Session</a>
                    <a href="404.html" class="dropdown-item">Scan Card</a>
                </div>
            </div>
        </div>
    </nav>
